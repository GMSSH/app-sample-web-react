...
function App() {
  ...
  return (
    ...
    <div>
        <button onClick={handleClick1} >打开文件系统</button>
    <button  onClick={handleClick2}>信息提示框</button>
    <button  onClick={handleClick3}>对话框</button>
    <button  onClick={handleClick4}>关闭当前应用</button>
    <button  onClick={handleClick5}>选取文件夹</button>
    <button  onClick={handleClick6}>选取文件</button>
    <button  onClick={handleClick7}>获取应用初始尺寸</button>
    <button  onClick={handleClick8}>打开代码编辑器</button>
    <button  onClick={handleClick9}>打开终端</button>
    <button  onClick={handleClick10}>打开日志</button>
    <button  onClick={handleClick11}>上传文件</button>
</div>
    </>
  )
}
